...
// called waivers.<name>
var BOOKS = ["lipsync", "general", "volleyball", "dodgeball", "track", "treds", "basketball", "trivia", "larp", "dizzy", "donut", "tugowar", "delivery", "joust", "bedrace"];
...
var readBookToDatabase = function( name, cb ) {
  ...
  try {
    book = xlsx.readFile( `${name}-waivers18.xls` );
  } catch( e ) {
    book = xlsx.readFile( `${name}-waivers18.xlsx` );
  }
